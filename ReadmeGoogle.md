...
Dette prosjektet er et **Google-inspirert Home page** og en skoleoppgave.  
Målet er å øve på:

- Flexbox
- Design med CSS

Nettsiden etterligner en Google home page

## Oppgavebeskrivelse

I denne oppgaven skulle vi lage en nettside som ligner på bildet læreren har gitt (Google-design).

Krav til siden:

- Bruke det tilsendte **bildene** over hele siden.
- Style skjemaet slik at det passer til **Google-stilen**:
  - Google logo
  - Shearch bar 
  - hvit background
  - Noen relevante ikoner
...
- [CSS](https://www.w3schools.com/css/default.asp)
  - Flexbox
  - Styling av input, linker, bilder og knapp

## Funksjoner

- Tydelig **SignIn-knapp**
- Input-boks som kan skrives inn noe
- Linker og knapper som kan klikkes på
...
![Forventet resultat](./Images/fr.png)
